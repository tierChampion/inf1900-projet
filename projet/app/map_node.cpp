...
void MapNode::setCardinalDist(Direction direction, uint8_t newDistance)
{
    ...
    case Direction::NORTH:
        ...
        break;
    case Direction::SOUTH:
        _verticalDistances = (_verticalDistances & MASK_NORTH_NODE_DISTANCE) | ((newDistance << 4) & MASK_SOUTH_NODE_DISTANCE);
        break;
    case Direction::EAST:
        _lateralDistances = (_lateralDistances & MASK_WEST_NODE_DISTANCE) | (newDistance & MASK_EAST_NODE_DISTANCE);
        break;
    case Direction::WEST:
        _lateralDistances = (_lateralDistances & MASK_EAST_NODE_DISTANCE) | ((newDistance << 4) & MASK_WEST_NODE_DISTANCE);
        break;
    }
}
